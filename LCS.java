...
public class LCS
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String[] X =  read("location");
        String[] Y = read("bug location");
        ...
        String[] arr = lcs(X, Y, m, n, T).split("!");
    ...
    public static ArrayList<String> shortestUnCommonPath(ArrayList<String> longest, ArrayList<String> fail, int indexLongest, int indexFail){
        int nextFailIn = 0;
